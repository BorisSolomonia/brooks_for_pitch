...
import com.brooks.security.JwtConfig;
...
public class AuthSecurityConfig {
  ...
  public JwtService jwtService(
      @Value("${brooks.jwt.issuer}") String issuer,
      @Value("${brooks.jwt.secret}") String secret,
      @Value("${brooks.jwt.access-ttl-seconds}") long accessTtlSeconds
  ) {
    return new JwtService(new JwtConfig(issuer, secret, accessTtlSeconds));
  }
