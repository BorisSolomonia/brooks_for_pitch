...
/**
 * Subtle Michelangelo-inspired sketch decorations.
 * Rendered as fixed SVG elements — infrequent, positioned at margins.
 */
export function SketchOverlay() {
  return (
    <div className="sketch-overlay" aria-hidden="true">
      ...
      <svg className="sketch sketch-br" width="120" height="60" viewBox="0 0 120 60">
        <path
      ...
      {/* Mid-left: small spiral (notebook margin doodle) */}
      <svg className="sketch sketch-ml" width="50" height="50" viewBox="0 0 50 50">
        <path
